        ...
        <>
			<div className='flex justify-center'>
				<div style={{ width:'600px'}} className='pt-8'>
					...
					<div style={{ backgroundColor:'#eee'}} className='relative h-3 rounded-md mb-4'>
					{/* 여기 부분어떻게 하는지 모르겠음 */}
					</div>

					<div style={{ boxShadow:'3px 3px 10px 0 rgba(0, 0, 0, 0.16)'}} 
						className='bg-white rounded-md border'>
						<div className='py-4 px-6 border-b border-solid border-gray-100 font-medium text-lg'> 📣  파티 이용료를 안내드립니다!</div>

						<div className='py-4 px-6 border-b border-solid border-gray-100'>
							<div className='flex justify-between'>
								<div className='text-sm line-through text-gray-400'>닌텐도 이용요금</div>
								<div className='text-sm line-through text-gray-400'>37,900원</div>
							</div>
						...
						<div style={{ backgroundColor:'#fee500'}} 
							...
							<button>
								<a className='flex-1' href={redirectUri}>카카오페이로 결제하기</a>
							</button>
						</div>
